...
<div class="logo">
    <a href="index.htm">
        ...
        <img alt="vmc_and_hmc" src="resources/assets/images/uoObrands/eef_tech-logo.svg" width="233" height="54"/>
...
<!-- ============================================================= LOGO : END ============================================================= -->     </div><!-- /.logo-holder -->
    ...
    <div class="phone inline">
        <i class="fa fa-phone"></i>  <span class="le-color">+375 23 40 7-18-81</span>
    </div>
    <div class="contact inline">
        <!--<i class="fa fa-envelope"></i> contact@<span class="le-color">hmccnc.com</span>-->
        <i class="fa fa-envelope"></i> <span class="le-color">bm7070@mail.ru</span>
    </div>
    <%--<div class="contact inline">--%>
                    ...
                    <div class="basket-item">
                        <div class="row">
                            <div class="col-xs-12 col-sm-6">
                                ...
                                <a href="basket.htm" class="le-button inverse">Перейти</a>
                            </div>
                            <div class="col-xs-12 col-sm-6">
                                <a href="#" class="le-button">Очистить</a>
