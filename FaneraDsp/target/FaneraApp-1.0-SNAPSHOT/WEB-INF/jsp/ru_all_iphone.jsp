        ...
        <%--</c:choose>--%>
                <c:choose>
                    <c:when test="${chIphone6s==1}">
                      <li><input checked="checked"  class="le-checkbox" type="checkbox"  name = 'checkbox_iphone6s' value='1'/> <label>Обычная ДСП</label> </li>
                    </c:when>
                    <c:otherwise>
                        <li><input  class="le-checkbox" type="checkbox"  name = 'checkbox_iphone6s' value='1'/> <label>Обычная ДСП</label> </li>
                    </c:otherwise>
                </c:choose>
                        <c:choose>
                            <c:when test="${chIphone6splus==1}">
                              <li><input checked="checked"  class="le-checkbox" type="checkbox"  name = 'checkbox_iphone6splus' value='1'/> <label>Ламинимрованная ДСП</label> </li>
                            </c:when>
                            <c:otherwise>
                                <li><input  class="le-checkbox" type="checkbox"  name = 'checkbox_iphone6splus' value='1'/> <label>Ламинимрованная ДСП</label> </li>
                            </c:otherwise>
                        </c:choose>
        ...
        <c:otherwise>
            ...
            <c:choose>
                <c:when test="${color=='зелёный'}">
                  <option selected value="зелёный" > Фоновый  </option>
                </c:when>
                <c:otherwise>
                     <option  value="зелёный" > Фоновый </option>
                </c:otherwise>
            </c:choose>   

                <c:choose>
                    <c:when test="${color=='золотой'}">
                      <option selected value="золотой" > Древесный </option>
                    </c:when>
                    <c:otherwise>
                         <option  value="золотой" > Древесный </option>
                    </c:otherwise>
                </c:choose>   
