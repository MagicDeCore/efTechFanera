...
<div id="main">
    <div id="content">
        <div id="login">
            ...
            <div id="logo"><span>Login to Control Pannel</span></div>

            <form method="post" action="${pageContext.request.contextPath}/j_spring_security_check" id="form-login" class="formBox">
                <fieldset>
                    <div class="form-col">
                        <label for="username" class="lab">Login <span class="warning"></span></label>
                    ...
                    <div class="form-col form-col-check">
                        <label><input type="checkbox" name="_spring_security_remember_me" class="checkbox" />Remember me</label>
                    </div>
                    <div class="form-col form-col-right">
